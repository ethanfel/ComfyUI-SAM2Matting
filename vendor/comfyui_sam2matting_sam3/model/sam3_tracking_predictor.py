...
from comfyui_sam2matting_sam3.model.sam3_tracker_base import concat_points, NO_OBJ_SCORE, Sam3TrackerBase
from comfyui_sam2matting_sam3.model.sam3_tracker_utils import fill_holes_in_mask_scores
from comfyui_sam2matting_sam3.model.utils.sam2_utils import load_video_frames
...
class Sam3TrackerPredictor(Sam3TrackerBase):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # Autocast is owned by the caller. Keeping a context entered for the
        # predictor's entire lifetime leaks CUDA autocast into unrelated ComfyUI
        # nodes running on the same thread.
