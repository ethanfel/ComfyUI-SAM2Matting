...
from comfyui_sam2matting_sam3.model.box_ops import fast_diag_box_iou
from comfyui_sam2matting_sam3.model.data_misc import BatchedDatapoint
from comfyui_sam2matting_sam3.model.sam3_tracker_utils import fill_holes_in_mask_scores, mask_to_box
from comfyui_sam2matting_sam3.perflib.masks_ops import mask_iou
# from comfyui_sam2matting_sam3.train.masks_ops import rle_encode
...
class Sam3VideoBase(nn.Module):
    ...
    def run_tracker_update_planning_phase(
        ...
        if self.rank == 0:
            ...
            if self.suppress_det_close_to_boundary: # False
    ...
    def _associate_det_trk(
        ...
        if self.o2o_matching_masklets_enable: # False
