...
from comfyui_sam2matting_sam3.sam.rope import apply_rotary_enc, apply_rotary_enc_real, compute_axial_cis
...
class Attention(nn.Module):
    ...
    def forward(self, q: Tensor, k: Tensor, v: Tensor) -> Tensor:
        ...
        if self.use_fa3:
            from comfyui_sam2matting_sam3.perflib.fa3 import flash_attn_func
